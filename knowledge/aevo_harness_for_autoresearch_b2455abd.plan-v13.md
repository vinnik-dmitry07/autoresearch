...
- **Archive bloat**: P1 keeps all candidates but caps the **active selection set** (top-N by `alpha` + a novelty sample); P2 Curator GC (active/stale/archived, never-delete, pin, provenance) + FTS index. [P1 cap; P2 Curator]
...
5. **Phase 1 runs with all optional layers OFF** — meta-agent, QD, curator, sweep, FTS, convergence are all disabled and the core still completes a full-budget run end-to-end.
